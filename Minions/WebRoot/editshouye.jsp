...
function editbannerspic(id){

//file.jsp?fileName=large_elvf_41230000bbd6125e.jpg
	//alert(id);
	...
	//alert(name);
	document.getElementById(id+'pic').src="file.jsp?fileName="+name;
...
#changes1{
    ...
    <!--头部开始-->
        ...
        <table width="960" border="0" cellspacing="0" cellpadding="0" id="header2_tab1">
          <tr>
            ...
            <td align="right">
             <form action="findGoods/search_doSearchByWord" method="post">
	...
	function on_5(){
	 ...
	 function leave_5(){
       ...
       <form action="admin/editbanner_saveBanner" enctype="multipart/form-data" method="post" >
        <div id="header4">
        <img src="<%=basePath%>/images/laba.gif" width="16" height="14" /> 公告:·<font color="#ED1C24"><input style="background-color: #efefef;" size="60" name="gonggao" class="editinput" type="text" id="gonggao" value="<s:property  value="#session.gonggao.shouyebannerContent"/>" readonly="readonly"/></font>
        <input type="button" class="editclass" value="编辑" onclick="editbanners('gonggao')"/>
        </div>
	...
	<img id="banner11pic"  src="<%=basePath%>/images/<s:property value="#session.banner1.shouyebannerContent"/>?a=<%=new Random().nextFloat() %>"  width="960" height="70" border="0" onclick = "banner11.click();" />
	 
	  <input type="file" id="banner11"  name="banner1" onchange="editbannerspic('banner11')" class="fileinput"/>
        	  ...
        	  <div id="TabbedPanels1" class="TabbedPanels">
        	    ...
        	    <div class="TabbedPanelsContentGroup">
                  ...
                  <table class="hotneirong" border="0" cellpadding="0" cellspacing="0" width="235">
                       <tr>
                        <td height="25">◆<input size="23" name="hotact1" id="hotact1" class="editinput" type="text"  value="<s:property  value="#session.hotact1.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('hotact1')"/>
                        </td>
                       </tr>
                       <tr>
                        <td height="25">◆<input size="23" name="hotact2" id="hotact2" class="editinput" type="text"  value="<s:property  value="#session.hotact2.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('hotact2')"/>
                        </td>
                       </tr>
                       <tr>
                        <td height="25">◆<input size="23" name="hotact3" id="hotact3" class="editinput" type="text"  value="<s:property  value="#session.hotact3.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('hotact3')"/>
                        </td>
                       </tr>
                       <tr>
                        <td height="25">◆<input size="23" name="hotact4" id="hotact4" class="editinput" type="text"  value="<s:property  value="#session.hotact4.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('hotact4')"/>
                        </td>
                       </tr>
                  </table>
                  </div>
        	      <div class="TabbedPanelsContent">
              		<table class="hotneirong" border="0" cellpadding="0" cellspacing="0"  width="235">
                       <tr>
                        <td height="25">◆<input size="23" name="situation1" id="situation1" class="editinput" type="text"  value="<s:property  value="#session.situation1.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('situation1')"/>
                        </td>
                       </tr>
                       <tr>
                        <td height="25">◆<input size="23" name="situation2" id="situation2" class="editinput" type="text"  value="<s:property  value="#session.situation2.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('situation2')"/>
                        </td>
                       </tr>
                       <tr>
                        <td height="25">◆<input size="23" name="situation3" id="situation3" class="editinput" type="text"  value="<s:property  value="#session.situation3.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('situation3')"/>
                        </td>
                       </tr>
                       <tr>
                        <td height="25">◆<input size="23" name="situation4" id="situation4" class="editinput" type="text"  value="<s:property  value="#session.situation4.shouyebannerContent"/>" readonly="readonly"/>
                        <input type="button" class="editclass" value="编辑" onclick="editbanners('situation4')"/>
                        </td>
                       </tr>
                  </table>
    ...
    <div id="hotpartition">
        ...
        <div id="hotpartition_right">
         <a href="getGoodsInfo/getGoodsInfo_getGoods.action?goodId=7&colorId=2">
    ...
    <!--首页  1F  开始-->
        ...
        <div id="floor1">
          ...
          <img id="fapic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f1.shouyebannerContent"/>" width="295" height="490"  border="0"  onclick = "fa.click();" />
		  <input type="file" id="fa"  name="of1" onchange="editbannerspic('fa')" class="fileinput"/>
          
         
          </div>
          <div id="floor1_main"> 
     	 	<img id="fbpic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f2.shouyebannerContent"/>" width="228" height="141"   border="0"  onclick = "fb.click();" /><input type="file" id="fb"  name="of2" onchange="editbannerspic('fb')" class="fileinput"/><img id="fcpic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f3.shouyebannerContent"/>" width="228" height="141"   border="0"  onclick = "fc.click();" /><input type="file" id="fc"  name="of3" onchange="editbannerspic('fc')" class="fileinput"/><img id="fdpic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f4.shouyebannerContent"/>" width="228" height="141"   border="0"  onclick = "fd.click();" /><input type="file" id="fd"  name="of4" onchange="editbannerspic('fd')" class="fileinput"/><img id="fepic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f5.shouyebannerContent"/>" width="228" height="141"   border="0"  onclick = "fe.click();" /><input type="file" id="fe"  name="of5" onchange="editbannerspic('fe')" class="fileinput"/><img id="ffpic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f6.shouyebannerContent"/>" width="151" height="205"   border="0"  onclick = "ff.click();" /><input type="file" id="ff"  name="of6" onchange="editbannerspic('ff')" class="fileinput"/><img id="fgpic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f7.shouyebannerContent"/>" width="151" height="205"   border="0"  onclick = "fg.click();" /><input type="file" id="fg"  name="of7" onchange="editbannerspic('fg')" class="fileinput"/><img id="fhpic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f8.shouyebannerContent"/>" width="151" height="205"   border="0"  onclick = "fh.click();" /><input type="file" id="fh"  name="of8" onchange="editbannerspic('fh')" class="fileinput"/>
			
            </div>
            <div id="floor1_right"> 
            <img id="fipic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f9.shouyebannerContent"/>" width="197" height="240" border="0"   onclick = "fi.click();" />
			  <input type="file" id="fi"  name="of9" onchange="editbannerspic('fi')" class="fileinput"/>
          	<img id="fjpic"  src="<%=basePath%>/images/<s:property  value="#session.lst1f10.shouyebannerContent"/>" width="197" height="245" border="0"   onclick = "fj.click();" />
			  <input type="file" id="fj"  name="of10" onchange="editbannerspic('fj')" class="fileinput"/>
    ...
    <!--首页  3F  开始-->
        ...
        <div id="floor3_gooods">
            <table width="960" border="0" cellspacing="0" cellpadding="0">
            	...
            	<tr>
					<s:iterator value="#session.girlGoods" id="good" status="number" begin="0" end="1">
				      
				        <td class="goods">
					      <table>
						        <tr>
						        <td colspan="2" class="goods_paddingright goods_paddingtop">
				                <a href="#"><img src="<%=basePath%>/images/floor3_goods11.jpg" width="174" height="174"  title="[JAMIE MOORE]AMY TOSCANA GROUP系列牛皮手提/斜挎包 银灰色" /></a>
				                </td>
						       
						        </tr>
						        
						        <tr>
						        	<td class="goods_miaoshu"><a href="#" title="[JAMIE MOORE]AMY TOSCANA GROUP系列牛皮手提/斜挎包 银灰色">[JAMIE MOORE]AMY TOSCANA ... </a><br /> <span class="goods_miaoshu">麦包价:</span>
				                <span class="goods_price">￥1480</span></b></font></td>
						        </tr>
					       </table>
				        </td>
