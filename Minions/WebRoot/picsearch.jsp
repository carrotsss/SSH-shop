...
<table width="960" border="0" cellspacing="5" cellpadding="5" class="nb_md3_tb" align="center">
	<tr><td>你有可能查找的是：</td></tr>
	<tr>
	
	<s:iterator value="#session.lstGoodsimg" id="goodsimg" status="number" begin="0" end="1">
      
        <td class="goods">
	      <table>
		        <tr>
		        <td>
		        <a href="shangpin.html"><img src="<%=basePath%>/images/<s:property  value="#goodsimg.goodsimgImg"/>" width="174" height="174" border="0"/></a>
		        </td>
		       
		        </tr>
		        
		        <tr>
		        	<td class="goods" >[卓尼尔]<s:property  value="#goodsimg.goods.goodName"/><br /> 买包价：<font color="#ed1c24" size="-1"><b>¥<s:property  value="#goodsimg.goods.goodPrice"/></b></font></td>
		        </tr>
		        <tr><td class="goods" >
		        <font color="red">
		        相似度：<s:property  value="#goodsimg.similarity"/>%
		        </font>
		        </td></tr>
	       </table>
        </td>
